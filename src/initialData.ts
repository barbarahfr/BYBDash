...
export const INITIAL_CLIENTS: Client[] = [
  ...
  },
  {
    ...
    scopeDetails: {
      paid_media: {
        clientes: 'Aditek',
        relacionamento: 'Victor',
        atendimento: 'Gabriela/Maurício',
        responsavelMidias: 'Guilherme',
        back: 'Rafa',
        abcd: 'A',
        peso: '2',
        pesoBack: '0',
        email: 'giovanna.moreira@aditek.com.br, gabriela.castro@aditek.com.br, eduardo.barbosa@aditek.com.br, jessica.carlet@aditek.com.br',
        business: 'B2B',
        setor: 'Industria',
        segmento: 'Ortodontia',
        objetivo: 'Lead',
        ferramentaMktCrm: 'RD Station / mapear crm',
        sedeCliente: 'Cravinhos - SP',
        midias: 'AW, FB',
        investTotal: 'R$ 12.000,00',
        google: 'R$ 2.000,00',
        meta: 'R$ 10.000,00',
        linkedin: '',
        tiktok: '',
        ...
        redeSocial: 'Cliente',
        tipo: '',
        relatorioApresentacao: 'Reportei Aditek',
        linkRelatorio: '',
        drive: 'Drive',
        planoMidias: 'Plano Aditek',
        onboarding: 'Não tem',
        ga4: 'ATUALIZAR',
        tintim: '',
        leadSheet: 'https://docs.google.com/spreadsheets/d/1MrU-fDqSY5_9N_TGjpLICyuv-C4Wr82wpodJfDsQhrE/edit?gid=0#gid=0',
        conversionSheet: '',
        apiMeta: 'FAZER',
        apiGoogle: 'FAZER',
        apiTiktok: '',
